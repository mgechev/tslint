...
var Linter = (function () {
    ...
    Linter.prototype.applyFixes = function (fileName, source, ruleFailures) {
        var _this = this;
        var sourceFile = this.getSourceFile(fileName, source);
        ...
        if (hasFixes) {
            ...
            Object.keys(fixesPerFile).forEach(function (currentFileName) {
                ...
                source = rule_1.Fix.applyAll(source, fixesForFile);
                fs.writeFileSync(currentFileName, source, { encoding: "utf-8" });
                // reload AST if file is modified
                sourceFile = _this.getSourceFile(currentFileName, source);
            });
        }
        return source;
    };
